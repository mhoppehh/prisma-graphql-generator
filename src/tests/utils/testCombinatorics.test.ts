...
describe('allSubsets', () => {
  ...
  it('returns all subsets for a 2-element array', () => {
    expect(allSubsets(['a', 'b'])).toEqual([[], ['a'], ['b'], ['a', 'b']])
  })

  it('returns all subsets for a 3-element array', () => {
    expect(allSubsets([1, 2, 3])).toEqual([[], [1], [2], [1, 2], [3], [1, 3], [2, 3], [1, 2, 3]])
  })
})
...
describe('cartesianProduct', () => {
  ...
  it('returns correct product for three arrays of strings', () => {
    expect(cartesianProduct([['1', '2'], ['a'], ['x', 'y']])).toEqual([
      ['1', 'a', 'x'],
      ['1', 'a', 'y'],
      ['2', 'a', 'x'],
      ['2', 'a', 'y'],
